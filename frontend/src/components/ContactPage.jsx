...
import { User, Mailbox, MessageSquare, Phone, MessageCircleDashedIcon, SendHorizonal, MessageCircle } from 'lucide-react';
...
const ContactPage = () => {
    ...
    const handleSubmit = (e) => {
        ...
        const whatsappUrl = `https://wa.me/919724025104?text=${whatsappMessage}`;
