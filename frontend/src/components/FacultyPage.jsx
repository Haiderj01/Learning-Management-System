            ...
            <div className={facultyStyles.header}>
                <div className={facultyStyles.headerContent}>
                    ...
                    <p className={facultyStyles.subtitle}>
                        Our faculty members are experts in their fields, dedicated to providing a high-quality education to our students.
                    </p>
                </div>
            </div>
                            ...
                            >
                                <div className={facultyStyles.teacherCard}>
                                    ...
                                    <div className={facultyStyles.socialContainer}>
                                       <a href={`mailto:${teacher.email}`} className={`${facultyStyles.socialIcon} ${facultyStyles.socialIconEmail}`}
