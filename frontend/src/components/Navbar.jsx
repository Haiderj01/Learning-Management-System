...
import { BookMarked, BookOpen, Contact, Home, Users, X, Menu, BookOpenText } from 'lucide-react';
...
const Navbar = () => {
  ...
  const navItems = isSignedIn
   ? [
       ...baseNav,
       { name: "MyCourses", icon: BookOpenText, href: '/mycourses' },
     ]
   : baseNav;
      ...
      <div className={navbarStyles.container}>
        <div className={navbarStyles.innerContainer}>
          ...
          <div className=" flex items-center gap-3 select-none">
            ...
            <div className="text-xl font-bold bg-clip-text text-transparent bg-linear-to-r from-sky-700 to-cyan-600
              ...
              {navItems.map((item) => {
                ...
                return (
                  <NavLink key={item.name} to={item.href} end={item.href === '/'} className={({ isActive }) => mobileLinkClass({ isActive })} onClick={() => setIsOpen(false)}>
                    <div className={navbarStyles.mobileMenuItemContainer}>
