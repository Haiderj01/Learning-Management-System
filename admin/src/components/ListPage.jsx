...
import { listStyles } from "../assets/dummyStyles.js";
import { toast, Toaster } from 'react-hot-toast';
import axios from 'axios';
import { Star, Search, Eye, EyeClosed, BookOpen, Clock, Trash2, Video, ListIndentDecrease } from "lucide-react";
        ...
        <div className={listStyles.pageContainer}>
            ...
            <div className={listStyles.contentContainer}>
                <div className={listStyles.headerContainer}>
                    <h1 className={listStyles.headerTitle}>
                        Course Catalog
                    </h1>
                ...
                <div className={listStyles.searchContainer}>
                    <div className={listStyles.searchInputContainer}>
                        ...
                        <input type="text" placeholder="Search courses, instructors, or categories.. " value={searchTerm}
                            onChange={(e) => setSearchTerm(e.target.value)} className={listStyles.searchInput}
                        />
                    </div>
                </div>
                    ...
                    {!loading && filteredCourses.length === 0 && (
                        <div className={listStyles.emptyState}>
                            ...
                            <p className={listStyles.emptyText}>
                                No courses found matching your serach
                            </p>
