...
import { BadgeIndianRupee, BookMarked, ShoppingCart, Users, BookOpenText, Search } from "lucide-react";
                ...
                <div className={dashboardStyles.coursesContainer}>
                    <div className={dashboardStyles.coursesHeader}>
                        <div className={dashboardStyles.coursesTitleContainer}>
                            ...
                            <h2 className={dashboardStyles.coursesTitle}>Course Performance
